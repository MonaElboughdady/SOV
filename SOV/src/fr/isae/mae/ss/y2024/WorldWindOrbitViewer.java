		    ...
		    Runnable updateOrbitPath = () -> {
		        try {
		            Orbit updatedOrbit = new KeplerianOrbit(
		                    Constants.WGS84_EARTH_EQUATORIAL_RADIUS + (orbitSidePanel.getSliderAValue() * 1e6),
		                    orbitSidePanel.getSliderEValue(),
		                    Math.toRadians(orbitSidePanel.getSliderIValue()),
		                    Math.toRadians(orbitSidePanel.getSliderOmegaValue()),
		                    Math.toRadians(orbitSidePanel.getSliderUpperOmegaValue()),
		                    Math.toRadians(orbitSidePanel.getSliderVValue()),
		                    PositionAngle.MEAN,
